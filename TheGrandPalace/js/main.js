...
function preload() {
    ...
    // Preload animations
    arrow = loadAnimation('image/arrow.png', 'image/arrow2.png', 'image/arrow3.png', 'image/arrow4.png');
...
function MCBtn() {
    ...
    if (power <= 55) {
        ...
        pass = false;
        dialogText.html("Unfortunately, due to the opposition from the majority of the court, I am unable to carry out this solution. I believe this is a responsible choice for millions of people in our nation. Please forgive me for advising you to reconsider your decision.")
    }
}
